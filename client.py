...
def main():
    ...
    list_of_users = ['test1', 'test2', 'test3']
    # Если имя пользователя не было задано, необходимо запросить пользователя.
    if not client_name:
        client_name = input('Введите имя пользователя: ')
        # Выводим список активных пользователей, но при этом исключаем из него подключившегося юзера
        if client_name in list_of_users:
            list_of_users.remove(client_name)
