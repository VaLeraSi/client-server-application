...
from common.variables import DEFAULT_PORT, MAX_CONNECTIONS, ACTION, TIME, \
    ...
    MESSAGE_TEXT, RESPONSE_400, DESTINATION, RESPONSE, EXIT
        ...
        if recv_data_lst:
            for client_with_message in recv_data_lst:
                try:
                    ...
                    # Удаляем имя клиента при разрыве соединение (для повторного использования имени)
                    for key, value in names.copy().items():
